                ...
                <div class="card border-0">
                    ...
                    <div class="card-body p-5">
                        <ul class="list-group list-group-flush text-center">
                            ...
                            <li class="text-center px-0 my-5">
...
<?php echo $__env->make($activeTemplate.'layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/project/loggsplug/core/resources/views/templates/basic/user/payment/Enkpay.blade.php ENDPATH**/ ?>