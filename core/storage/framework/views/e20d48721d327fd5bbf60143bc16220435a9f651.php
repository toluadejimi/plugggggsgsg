            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <a href="https://t.me/Dmloggsplugdotcomdotcom" class="text-dark">Telegram Customer Service</a>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <a href="https://t.me/Dmloggsplugdotcomdotcom" class="text-dark">Telegram Channel</a>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        ...
                        <a href="https://Wa.me/+2347049631912" class="text-dark">Whatsapp Group</a>
...
<?php echo $__env->make($activeTemplate . 'layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/project/loggsplug/core/resources/views/templates/basic/contact.blade.php ENDPATH**/ ?>
