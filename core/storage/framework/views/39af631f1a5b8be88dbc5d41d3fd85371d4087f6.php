        ...
        <div class="container bottom-content">
            <div class="location-area">
                <div class="d-flex align-items-center">
                    ...
                    <div class="ms-3">
                        ...
                        <span class="font-14 font-w600"><?php echo e($order->id); ?></span>
                    </div>
                </div>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="ms-3">
                    ...
                    <span class="font-14 font-w600"><?php echo e($order->gift_item); ?></span>
                </div>
            </div>
            ...
            <div class="order-status">
                ...
                <ul class="dz-timeline style-1">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $order_track; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>

                        <li class="timeline-item active">
                            <h6 class="timeline-tilte"><?php echo e($data->note); ?></h6>
                            <?php
                                $dateTime = Carbon::parse($data->created_at);
                            ?>
                            <p class="timeline-date"><?php echo e($dateTime->format('M j, Y - g:ia')); ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/project/loggsplug/core/resources/views/templates/basic/user/track-order.blade.php ENDPATH**/ ?>