        ...
        <div class="container profile-area">
            <div class="profile">
                <div class="media media-100">
                    <img src="<?php echo e(url('')); ?>/assets/assets/images/fav.svg" alt="author-image" height="100px" width="100px">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="offer-bx">
                                    ...
                                    <div class="point">
                                        <h5 class="title"><?php echo e($orders); ?></h5>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide" >
                                <div class="offer-bx" >
                                    <div class="offer-content">
                                        ...
                                        <h5 style="color: white" class="title"><?php echo e(number_format($spent)); ?></h5>
...
<?php echo $__env->make($activeTemplate . 'layouts.nofooter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/project/aacelogs/core/resources/views/templates/basic/user/profile.blade.php ENDPATH**/ ?>