        ...
        <div class="col-xl-12 col-sm-12">
            <div class="dashboard-widget">
                <div class="row">
                    ...
                    <div class="col-5"
                         style="font-size: 10px;">  <?php $text = $product->name.' | '.strLimit(strip_tags($product->description), 30); ?>
                    ...
                    <div class="col-3">
                        <a class="text-black"
                           style="font-size: 10px;"> <?php echo e($general->cur_sym); ?><?php echo e(showAmount($product->price)); ?> </a>
                    </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/project/loggsplug/core/resources/views/templates/basic/partials/products.blade.php ENDPATH**/ ?>